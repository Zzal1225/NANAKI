  ...
  return createPortal(
    <div className="fixed inset-0 z-[100] flex items-end justify-center p-0 sm:items-center sm:p-4">
      ...
      <div
        ...
        aria-modal="true"
        aria-label={title}
        className="relative z-10 flex max-h-[min(90dvh,100%)] w-full max-w-lg min-h-0 flex-col overflow-hidden rounded-t-3xl border border-border bg-surface-raised sm:rounded-3xl"
      >
